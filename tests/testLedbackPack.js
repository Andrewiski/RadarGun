...
//var bonescript;
try {
    const I2CDevrice = 1;  // 1 for Raspberry Pi  //2 for Beagle bone
    ...
    adafruitLedBackpack.Initialize({ I2CAddress: 0x70, I2CDevrice: I2CDevrice }, function (err) {
    ...
    adafruitLedBackpack2.Initialize({ I2CAddress: 0x71, I2CDevrice: I2CDevrice }, function (err) {
    ...
    adafruitLedBackpack3.Initialize({ I2CAddress: 0x72, I2CDevice: I2CDevrice }, function (err) {
